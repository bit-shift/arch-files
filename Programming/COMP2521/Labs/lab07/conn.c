...
int main(int argc, char **argv)
{
	...
	id1 = (strlen(argv[1]) == 2) ? abbrevToID(argv[1]) : nameToID(argv[1], MIN_MAP_LOCATION, MAX_MAP_LOCATION);
	id2 = (strlen(argv[1]) == 2) ? abbrevToID(argv[2]) : nameToID(argv[2], MIN_MAP_LOCATION, MAX_MAP_LOCATION);
