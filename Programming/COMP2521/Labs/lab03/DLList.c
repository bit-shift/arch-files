...
// shows the status of the list
void statusDLList(DLList L)
{
    printf("Number of items in the List: %d\n", L->nitems);
    if (L->nitems > 0) {
        printf("Current item in the List: %s\n", L->curr->value);
    }
}
