% Takes the input parameters as defined below
% Graphs the bifurcation diagram for the defined dynamical system
% Analysis of the stability and instability of the parameter
...
% plot 
dcolor = [0,0,0]; % Marker color setting: blue        
